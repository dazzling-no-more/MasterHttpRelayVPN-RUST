...
|---|---|---|
| `rahgozar-android-universal-v2.7.0.apk` | Android 7.0+ (all ABIs), Android TV | Universal APK — arm64-v8a, armeabi-v7a, x86_64, x86 in one file. Also installable on Android TV (Shield, Mi Box, Chromecast with Google TV) |
...
**اندروید:** فایل `rahgozar-android-universal-v2.7.0.apk` را روی گوشی کپی کنید، از Files app روی آن tap کنید و اجازهٔ "نصب برنامه‌های ناشناس" را بدهید. راهنمای کامل شروع به کار (دیپلوی Apps Script، نصب CA، اجازهٔ VPN، تستر SNI) در [راهنمای اندروید](../docs/android.md) هست.
